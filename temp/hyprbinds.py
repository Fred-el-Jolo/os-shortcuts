...
ARGS = {
    ...
    "caelestia:launcher": "caelestia launcher",
    "caelestia:refreshDevices": "caelestra refresh devices",
}
...
def format_desc(*, arg: str = "", description: str = "",
    ...
    return disp.format(arg=a[:20], description=description).strip()
